    ...
    <div>
      ...
      <ResponsiveContainer width="100%" height={280}>
        <ComposedChart data={chartData} margin={{ top: 8, right: 16, left: 8, bottom: 0 }}>
          ...
          <Legend iconType="rect" iconSize={10} wrapperStyle={{ fontFamily: 'DM Sans, sans-serif', fontSize: 12 }} />
          ...
          {lineKey && <Line yAxisId="right" type="monotone" dataKey={lineKey} name={lineLabel} stroke={CHART_COLORS.gain} strokeWidth={2} dot={false} isAnimationActive animationDuration={600} />}
        </ComposedChart>
      </ResponsiveContainer>
    </div>
  );
